...
var inputToFindShow = document.querySelector("#input-show");
var buttonToSubmitSearch = document.querySelector("#submit-data");
var containerForShows = document.querySelector("#container");
buttonToSubmitSearch.addEventListener("click", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var baseUrl, searchTerm, findShowPromise, shows;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            searchTerm = inputToFindShow.value;
            _context.next = 5;
            return fetch("".concat(baseUrl).concat(searchTerm));

          case 5:
            findShowPromise = _context.sent;
            _context.next = 8;
            return findShowPromise.json();
          ...
          case 8:
            ...
            shows.forEach(function (show) {
              ...
              var showInfoDataSectionDiv = document.createElement("div");
